...
public class PropertyManager : IPropertyManager
{
    ...
    {
        var properties = _propertyResolver.GetProperties(contentData);
        var structuredData = new Dictionary<string, object>();

        foreach (var property in properties)
        {
            var propertyHandler = _propertyHandlerService.GetPropertyHandler(property);
            ...
            var key = _propertyNameStrategy.GetPropertyName(property);
